...
New features: Combine new commands with send strings to make complex macros! You can open files and webpages, run apps, activate windows, use text-to-speech amd more. Alt-M copies mouse coordinated to clipboard. You can delete unwanted setups.
...
2. SwitchWedge02_6_2_26.ahk -- The most recent AutoHotKey source file - sw.ini, SwitchWedge_.jpg, SwitchWedgeHelp.html should be in the same directory at runtime
3. SwitchWedge02_6_26.exe -- The most recent Windows executable - sw.ini, SwitchWedge_.jpg, SwitchWedgeHelp.html should be in the same directory at runtime
4. SwitchWedgeHelp06162026.html -- A help file that explains how to use SwitchWedge
5. switchWedge.ico -- icon for SwitchWedge included when compiling the ahk to exe (using Ahk2Exe.exe)
6. SwitchWedge 2026-09-18.png -- a screenshot of the SwitchWedge controls used for the help page
