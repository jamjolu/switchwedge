...
Gui, Add, DropDownList, x110 y2 w130 gSetMode vOpMode, %OpMode%||Single Switch|Two Switch|One Click|Two Click|Scan Mouse 1|Scan Mouse 2|Spot Scan 1|Spot Scan 2|Remap
...
Gui, Add, DropDownList, x110 y32 w60 gSetVars vkeyIn1, %keyIn1%||0|1|2|3|Space|Enter|Tab|+Tab|BackSpace|Right|Left|Up|Down|LButton|RButton|Joy1|Joy2|Joy3|Joy4|Joy5|Joy6|Joy7|Joy8|none
Gui, Add, DropDownList, x180 y32 w60 gSetVars vkeyIn2, %keyIn2%||0|1|2|3|Space|Enter|Tab|+Tab|BackSpace|Right|Left|Up|Down|LButton|RButton|Joy1|Joy2|Joy3|Joy4|Joy5|Joy6|Joy7|Joy8|none
Gui, Add, DropDownList, x250 y32 w60 gSetVars vkeyIn3, %keyIn3%||0|1|2|3|Space|Enter|Tab|+Tab|BackSpace|Right|Left|Up|Down|LButton|RButton|Joy1|Joy2|Joy3|Joy4|Joy5|Joy6|Joy7|Joy8|none
Gui, Add, DropDownList, x320 y32 w60 gSetVars vkeyIn4, %keyIn4%||0|1|2|3|Space|Enter|Tab|+Tab|BackSpace|Right|Left|Up|Down|LButton|RButton|Joy1|Joy2|Joy3|Joy4|Joy5|Joy6|Joy7|Joy8|none
Gui, Add, DropDownList, x390 y32 w60 gSetVars vkeyIn5, %keyIn5%||0|1|2|3|Space|Enter|Tab|+Tab|BackSpace|Right|Left|Up|Down|LButton|RButton|Joy1|Joy2|Joy3|Joy4|Joy5|Joy6|Joy7|Joy8|none
...
if (StartOff)
  {
     suspended = 1
     Suspend On
	 Gui, Show, x10 y10 %lastHgt% %lastWid%, SwitchWedge Switch Interface Enhancer is:  OFF -->Setup for: %iniH%
  } Else
  {
    suspended = 0
	Suspend Off
	Gui, Show, x10 y10 %lastHgt% %lastWid%, SwitchWedge Switch Interface Enhancer is:  ON -->Setup for: %iniH%
  }
 setTitleMatchMode 2
goSub, setMode
...
setupSaver:
 MsgBox,35, Save or Rename Setup?: %SaveSetup%, Do you want to save or rename this setup? --> "%SaveSetup%"
 ifMsgBox Yes
	{
	  inputBox, SaveSetup, Edit Setup Name, Edit setup name,,,,,,,,%SaveSetup% 
	  StringReplace, SaveSetup, SaveSetup, %bar_char%,, All
	  msgBox,1,New Setup OK?, New setup is called: %SaveSetup%
	  ifMsgBox OK
	    {
		   iniH = %SaveSetup%
...
customHelp:
 ...
 helpText = Specify custom messages for Key Sequences Sent by first entering text into the edit box below the Define Custom Key Sequences buttons, and then by clicking one of the Set Seq. # buttons. This sets a custom key sequence for the message sent for that trigger. The custom message also appears at the bottom of the Key Seq. Sent menu for that trigger. Special characters like enter and space have to be enclosed in braces as in {enter} and {space}. Send a left mouse click with {click} and right click with {click right}. For modifier keys use the following:`n ! sends Alt `n + sends Shift `n ^ sends Ctrl `n # sends Win `n For example: !{f4} sends Alt F4 `nMultiple charaters can be strung together. Refer to the Send command in  Autohotkey help for more details.
...
setHotkeys("0|1|2|3|Space|Enter|Tab|+Tab|BackSpace|Right|Left|Up|Down|LButton|RButton|Joy1|Joy2|Joy3|Joy4|Joy5|Joy6|Joy7|Joy8","Off")
